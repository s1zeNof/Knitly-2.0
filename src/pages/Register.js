    ...
    const handleRegister = async (event) => {
        ...
        try {
            ...
            if (error.code === 'auth/email-already-in-use') {
                ...
                setError('Пароль занадто слабкий. Він має містити щонайменше 6 символів.');
            } else {
        ...
        <div className="auth-page-container">
            <div className="auth-form-wrapper">
                <div className="auth-header">
                    <h1>Приєднатись до Knitly</h1>
                    <p>Створюйте, діліться та відкривайте нову музику.</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="auth-form">
                    ...
                    />
                     <input 
                        ...
                        required
                    />
                    <button type="submit" className="auth-submit-button">Створити акаунт</button>
                </form>
