...
const ArrowLeftIcon = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M19 12H5M12 5l-7 7 7 7"/></svg>;
        ...
        <div className="auth-page-container">
            <div className="auth-form-wrapper">
                ...
                <div className="auth-header">
                    <h1>{canGoBack ? 'Додати обліковий запис' : 'Вхід у Knitly'}</h1>
                    <p>{canGoBack ? 'Увійдіть в інший акаунт. Поточний залишиться активним.' : 'Продовжуйте творити та ділитися музикою.'}</p>
                </div>
