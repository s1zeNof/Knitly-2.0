    ...
    return (
        <div className="lp-content">
            ...
            <section id="s5" className="lp-section">
                ...
                <p>
                    Для реалізації будь-якого з цих прав скористайтесь налаштуваннями профілю або надішліть запит на <a href="mailto:privacy@knitly.app">privacy@knitly.app</a>. Ми розглянемо запит протягом 30 днів.
                </p>
            </section>
